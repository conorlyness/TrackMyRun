let coreQueries = {
  ...
  logRun: `Insert into public.runlog ("rundate", "distance", "notes", "rpe", "shoe") values ('{run.date}', '{run.distance}', '{run.notes}', '{run.rpe}', '{run.shoes}');`,
  editRun: `UPDATE public.runlog SET "distance" = '{run.distance}', "notes" = '{run.notes}', "rpe" = '{run.rpe}', "shoe" = '{run.shoe}' WHERE "rundate" = '{run.date}' AND "id" = '{run.id}';`,
